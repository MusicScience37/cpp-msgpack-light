...
/*!
 * \file
 * \brief Test of classes to support serialization of optional values.
 */
...
TEST_CASE(
    ...
    SECTION("serialize values") {
        std::optional<int> value;
        binary expected_binary;
        std::tie(value, expected_binary) = GENERATE(
            table<std::optional<int>, binary>({{std::nullopt, binary("C0")},
                {0, binary("00")}, {1, binary("01")}, {2, binary("02")}}));
